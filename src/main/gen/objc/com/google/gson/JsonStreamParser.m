...
- (ComGoogleGsonJsonElement *)next {
  ...
  @catch (JavaLangStackOverflowError *e) {
    @throw create_ComGoogleGsonJsonParseException_initWithNSString_withJavaLangThrowable_(@"Failed parsing JSON source to Json", e);
  }
  @catch (JavaLangOutOfMemoryError *e) {
    @throw create_ComGoogleGsonJsonParseException_initWithNSString_withJavaLangThrowable_(@"Failed parsing JSON source to Json", e);
  }
  @catch (ComGoogleGsonJsonParseException *e) {
    @throw [[e getCause] isKindOfClass:[JavaIoEOFException class]] ? create_JavaUtilNoSuchElementException_init() : (id) e;
  }
}
