...
- (jboolean)isAssignableFromWithJavaLangReflectType:(id<JavaLangReflectType>)from {
  ...
  if ([type_ isKindOfClass:[IOSClass class]]) {
    ...
    @throw nil_chk(ComGoogleGsonReflectTypeToken_buildUnexpectedTypeErrorWithJavaLangReflectType_withIOSClassArray_(type_, [IOSObjectArray arrayWithObjects:(id[]){ IOSClass_class_(), JavaLangReflectParameterizedType_class_(), JavaLangReflectGenericArrayType_class_() } count:3 type:IOSClass_class_()]));
  }
}
