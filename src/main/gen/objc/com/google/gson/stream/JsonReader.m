...
- (void)beginArray {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_BEGIN_ARRAY) {
    ...
    *IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1) = 0;
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected BEGIN_ARRAY but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath]));
  }
}
...
- (void)endArray {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_END_ARRAY) {
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected END_ARRAY but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath]));
  }
}
...
- (void)beginObject {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_BEGIN_OBJECT) {
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected BEGIN_OBJECT but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath]));
  }
}
...
- (void)endObject {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_END_OBJECT) {
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected END_OBJECT but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath]));
  }
}
...
- (NSString *)nextName {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_UNQUOTED_NAME) {
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected a name but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath]));
  }
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
...
- (NSString *)nextString {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_UNQUOTED) {
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected a string but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath]));
  }
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
  (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
  return result;
...
- (jboolean)nextBoolean {
  ...
  @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected a boolean but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath]));
}
...
- (void)nextNull {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_NULL) {
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected null but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath]));
  }
}
...
- (jdouble)nextDouble {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_NUMBER) {
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected a double but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath]));
  }
  ...
  if (!lenient_ && (JavaLangDouble_isNaNWithDouble_(result) || JavaLangDouble_isInfiniteWithDouble_(result))) {
    @throw create_ComGoogleGsonStreamMalformedJsonException_initWithNSString_(JreStrcat("$D$I$I$$", @"JSON forbids NaN and infinities: ", result, @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath]));
  }
  JreStrongAssign(&peekedString_, nil);
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
  (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
...
- (jlong)nextLong {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_NUMBER) {
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected a long but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath]));
  }
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_BUFFERED;
  jdouble asDouble = JavaLangDouble_parseDoubleWithNSString_(peekedString_);
  jlong result = JreFpToLong(asDouble);
  if (result != asDouble) {
    @throw create_JavaLangNumberFormatException_initWithNSString_(JreStrcat("$$$I$I$$", @"Expected a long but was ", peekedString_, @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath]));
  }
  JreStrongAssign(&peekedString_, nil);
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
  (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
...
- (jint)nextInt {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_LONG) {
    ...
    if (peekedLong_ != result) {
      @throw create_JavaLangNumberFormatException_initWithNSString_(JreStrcat("$J$I$I$$", @"Expected an int but was ", peekedLong_, @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath]));
    }
    peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
    (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
    return result;
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_NUMBER) {
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected an int but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath]));
  }
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_BUFFERED;
  jdouble asDouble = JavaLangDouble_parseDoubleWithNSString_(peekedString_);
  result = JreFpToInt(asDouble);
  if (result != asDouble) {
    @throw create_JavaLangNumberFormatException_initWithNSString_(JreStrcat("$$$I$I$$", @"Expected an int but was ", peekedString_, @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath]));
  }
  JreStrongAssign(&peekedString_, nil);
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
  (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
...
- (NSString *)description {
  return JreStrcat("$$I$I", [[self java_getClass] getSimpleName], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self));
}
...
jint ComGoogleGsonStreamJsonReader_doPeek(ComGoogleGsonStreamJsonReader *self) {
  ...
  if (peekStack == ComGoogleGsonStreamJsonScope_EMPTY_ARRAY) {
    ...
    *IOSIntArray_GetRef(nil_chk(self->stack_), self->stackSize_ - 1) = ComGoogleGsonStreamJsonScope_NONEMPTY_DOCUMENT;
  }
...
jint ComGoogleGsonStreamJsonReader_nextNonWhitespaceWithBoolean_(ComGoogleGsonStreamJsonReader *self, jboolean throwOnEof) {
  ...
  if (throwOnEof) {
    @throw create_JavaIoEOFException_initWithNSString_(JreStrcat("$I$I", @"End of input at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self)));
  }
  else {
    return -1;
  }
...
jboolean ComGoogleGsonStreamJsonReader_skipToWithNSString_(ComGoogleGsonStreamJsonReader *self, NSString *toFind) {
  for (; self->pos_ + [((NSString *) nil_chk(toFind)) java_length] <= self->limit_ || ComGoogleGsonStreamJsonReader_fillBufferWithInt_(self, [toFind java_length]); self->pos_++) {
    {
...
JavaIoIOException *ComGoogleGsonStreamJsonReader_syntaxErrorWithNSString_(ComGoogleGsonStreamJsonReader *self, NSString *message) {
  @throw create_ComGoogleGsonStreamMalformedJsonException_initWithNSString_(JreStrcat("$$I$I$$", message, @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath]));
}
...
- (void)promoteNameToValueWithComGoogleGsonStreamJsonReader:(ComGoogleGsonStreamJsonReader *)reader {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_DOUBLE_QUOTED_NAME) {
    ...
    @throw create_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected a name but was ", [reader peek], @"  at line ", ComGoogleGsonStreamJsonReader_getLineNumber(reader), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(reader), @" path ", [reader getPath]));
  }
}
