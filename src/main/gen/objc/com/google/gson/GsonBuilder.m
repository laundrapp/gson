...
- (ComGoogleGsonGson *)create {
  ...
  return create_ComGoogleGsonGson_initWithComGoogleGsonInternalExcluder_withComGoogleGsonFieldNamingStrategy_withJavaUtilMap_withBoolean_withBoolean_withBoolean_withBoolean_withBoolean_withBoolean_withComGoogleGsonLongSerializationPolicy_withJavaUtilList_(excluder_, fieldNamingPolicy_, instanceCreators_, serializeNulls_, complexMapKeySerialization_, generateNonExecutableJson_, escapeHtmlChars_, prettyPrinting_, serializeSpecialFloatingPointValues_, longSerializationPolicy_, factories);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[20].selector = @selector(registerTypeAdapterFactoryWithComGoogleGsonTypeAdapterFactory:);
  ...
  static const J2ObjcClassInfo _ComGoogleGsonGsonBuilder = { "GsonBuilder", "com.google.gson", ptrTable, methods, fields, 7, 0x11, 25, 15, -1, -1, -1, -1, -1 };
