...
- (ComGoogleGsonJsonElement *)serializeWithId:(JavaUtilDate *)src
  ...
  @synchronized(localFormat_) {
    ...
    return JreRetainedLocalValue(create_ComGoogleGsonJsonPrimitive_initWithNSString_(dateFormatAsString));
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleGsonDefaultDateTypeAdapter = { "DefaultDateTypeAdapter", "com.google.gson", ptrTable, methods, fields, 7, 0x10, 9, 3, -1, -1, -1, 12, -1 };
...
void ComGoogleGsonDefaultDateTypeAdapter_initWithJavaTextDateFormat_withJavaTextDateFormat_(ComGoogleGsonDefaultDateTypeAdapter *self, JavaTextDateFormat *enUsFormat, JavaTextDateFormat *localFormat) {
  ...
  JreStrongAssignAndConsume(&self->iso8601Format_, new_JavaTextSimpleDateFormat_initWithNSString_withJavaUtilLocale_(@"yyyy-MM-dd'T'HH:mm:ss'Z'", JreLoadStatic(JavaUtilLocale, US)));
...
JavaUtilDate *ComGoogleGsonDefaultDateTypeAdapter_deserializeToDateWithComGoogleGsonJsonElement_(ComGoogleGsonDefaultDateTypeAdapter *self, ComGoogleGsonJsonElement *json) {
  @synchronized(self->localFormat_) {
    @try {
      return JreRetainedLocalValue([((JavaTextDateFormat *) nil_chk(self->localFormat_)) parseWithNSString:[((ComGoogleGsonJsonElement *) nil_chk(json)) getAsString]]);
    }
    @catch (JavaTextParseException *ignored) {
    }
    @try {
      return JreRetainedLocalValue([((JavaTextDateFormat *) nil_chk(self->enUsFormat_)) parseWithNSString:[json getAsString]]);
    }
    @catch (JavaTextParseException *ignored) {
    }
    @try {
      return JreRetainedLocalValue([((JavaTextDateFormat *) nil_chk(self->iso8601Format_)) parseWithNSString:[json getAsString]]);
    }
    @catch (JavaTextParseException *e) {
      @throw create_ComGoogleGsonJsonSyntaxException_initWithNSString_withJavaLangThrowable_([json getAsString], e);
    }
  }
}
