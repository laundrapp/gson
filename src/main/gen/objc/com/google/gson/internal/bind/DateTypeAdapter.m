...
__attribute__((unused)) static JavaTextDateFormat *ComGoogleGsonInternalBindDateTypeAdapter_buildIso8601Format(void);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[4].selector = @selector(writeWithComGoogleGsonStreamJsonWriter:withId:);
  ...
  static const J2ObjcClassInfo _ComGoogleGsonInternalBindDateTypeAdapter = { "DateTypeAdapter", "com.google.gson.internal.bind", ptrTable, methods, fields, 7, 0x11, 5, 4, -1, -1, -1, 8, -1 };
...
JavaTextDateFormat *ComGoogleGsonInternalBindDateTypeAdapter_buildIso8601Format() {
  ...
  JavaTextDateFormat *iso8601Format = create_JavaTextSimpleDateFormat_initWithNSString_withJavaUtilLocale_(@"yyyy-MM-dd'T'HH:mm:ss'Z'", JreLoadStatic(JavaUtilLocale, US));
...
JavaUtilDate *ComGoogleGsonInternalBindDateTypeAdapter_deserializeToDateWithNSString_(ComGoogleGsonInternalBindDateTypeAdapter *self, NSString *json) {
  @synchronized(self) {
    ...
    @try {
      return JreRetainedLocalValue([((JavaTextDateFormat *) nil_chk(self->iso8601Format_)) parseWithNSString:json]);
    }
