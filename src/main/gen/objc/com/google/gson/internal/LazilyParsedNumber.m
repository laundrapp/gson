...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleGsonInternalLazilyParsedNumber = { "LazilyParsedNumber", "com.google.gson.internal", ptrTable, methods, fields, 7, 0x11, 7, 1, -1, -1, -1, -1, -1 };
...
id ComGoogleGsonInternalLazilyParsedNumber_writeReplace(ComGoogleGsonInternalLazilyParsedNumber *self) {
  return create_JavaMathBigDecimal_initWithNSString_(self->value_);
}
