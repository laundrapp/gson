...
//  source: /Users/Salton/Documents/Projects/gson/src/main/java/com/google/gson/internal/ConstructorConstructor.java
//
...
J2OBJC_FIELD_SETTER(ComGoogleGsonInternalConstructorConstructor_12, unsafeAllocator_, ComGoogleGsonInternalUnsafeAllocator *)

__attribute__((unused)) static void ComGoogleGsonInternalConstructorConstructor_12_initWithIOSClass_withJavaLangReflectType_(ComGoogleGsonInternalConstructorConstructor_12 *self, IOSClass *capture$0, id<JavaLangReflectType> capture$1);

__attribute__((unused)) static ComGoogleGsonInternalConstructorConstructor_12 *new_ComGoogleGsonInternalConstructorConstructor_12_initWithIOSClass_withJavaLangReflectType_(IOSClass *capture$0, id<JavaLangReflectType> capture$1) NS_RETURNS_RETAINED;

__attribute__((unused)) static ComGoogleGsonInternalConstructorConstructor_12 *create_ComGoogleGsonInternalConstructorConstructor_12_initWithIOSClass_withJavaLangReflectType_(IOSClass *capture$0, id<JavaLangReflectType> capture$1);
...
id<ComGoogleGsonInternalObjectConstructor> ComGoogleGsonInternalConstructorConstructor_newUnsafeAllocatorWithJavaLangReflectType_withIOSClass_(ComGoogleGsonInternalConstructorConstructor *self, id<JavaLangReflectType> type, IOSClass *rawType) {
  return create_ComGoogleGsonInternalConstructorConstructor_12_initWithIOSClass_withJavaLangReflectType_(rawType, type);
}
...
- (id)construct {
  ...
  @catch (JavaLangInstantiationException *e) {
    @throw create_JavaLangRuntimeException_initWithNSString_withJavaLangThrowable_(JreStrcat("$@$", @"Failed to invoke ", val$constructor_, @" with no args"), e);
  }
  @catch (JavaLangReflectInvocationTargetException *e) {
    @throw create_JavaLangRuntimeException_initWithNSString_withJavaLangThrowable_(JreStrcat("$@$", @"Failed to invoke ", val$constructor_, @" with no args"), [e getTargetException]);
  }
...
- (id)construct {
  ...
  @catch (JavaLangException *e) {
    @throw create_JavaLangRuntimeException_initWithNSString_withJavaLangThrowable_((JreStrcat("$@$", @"Unable to invoke no-args constructor for ", val$type_, @". Register an InstanceCreator with Gson for this type may fix this problem.")), e);
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleGsonInternalConstructorConstructor_12 = { "", "com.google.gson.internal", ptrTable, methods, fields, 7, 0x8018, 2, 3, 2, -1, 3, 4, -1 };
  return &_ComGoogleGsonInternalConstructorConstructor_12;
}

@end

void ComGoogleGsonInternalConstructorConstructor_12_initWithIOSClass_withJavaLangReflectType_(ComGoogleGsonInternalConstructorConstructor_12 *self, IOSClass *capture$0, id<JavaLangReflectType> capture$1) {
...
ComGoogleGsonInternalConstructorConstructor_12 *new_ComGoogleGsonInternalConstructorConstructor_12_initWithIOSClass_withJavaLangReflectType_(IOSClass *capture$0, id<JavaLangReflectType> capture$1) {
  J2OBJC_NEW_IMPL(ComGoogleGsonInternalConstructorConstructor_12, initWithIOSClass_withJavaLangReflectType_, capture$0, capture$1)
}

ComGoogleGsonInternalConstructorConstructor_12 *create_ComGoogleGsonInternalConstructorConstructor_12_initWithIOSClass_withJavaLangReflectType_(IOSClass *capture$0, id<JavaLangReflectType> capture$1) {
  J2OBJC_CREATE_IMPL(ComGoogleGsonInternalConstructorConstructor_12, initWithIOSClass_withJavaLangReflectType_, capture$0, capture$1)
}
